...
function SA() -- credits to kilookuoma for the Silent Aimbot
...
function AB() -- credits to anonymous i found this script in several different scripts
...
function mbullets1() -- credits to kilookuoma for this mb script
